...
#line 39 "parser.y"
           {
        char* t = newTemp();
        (yyval.expr_type).code = malloc(50);
        (yyval.expr_type).temp = t;
        sprintf((yyval.expr_type).code, "%s = %d", t, (yyvsp[0].num)); 
...
#line 46 "parser.y"
                    {
        char* t = newTemp();
        (yyval.expr_type).code = malloc( strlen( (yyvsp[-2].expr_type).code ) + strlen( (yyvsp[0].expr_type).code ) + 50 );
        (yyval.expr_type).temp = t;
        sprintf((yyval.expr_type).code, "%s\n%s\n%s = %s + %s", (yyvsp[-2].expr_type).code, (yyvsp[0].expr_type).code, t, (yyvsp[-2].expr_type).temp, (yyvsp[0].expr_type).temp);
    }
